...
var text20 = {},
    ...
    connector = {
        config: {
			...
			//lkastler
			/** class path to archive. If the classpath of the jar is not identical to the sites path**/
			classPath: ".",
                ...
                connect: function(){
                    ...
                    if(connector.config.useObjectTag) {
                        ...
                        $("body").append(
							...
							//lkastler
                            'codebase="' + connector.config.classPath + '"' +
        ...
        handler: {
            ...
            onGazeHandler: function(x, y){
                ...
                core.attributed.get("onGazeOut").each(function(i){
					...
					//lkastler: hack for embedding text2.0 into a firefox extension
					var unwrap = XPCNativeWrapper.unwrap(elem.context);
					
                    if (allUnderCurrentGaze.indexOf(unwrap) >= 0)
                        return;
            ...
            onFixationHandler: function(x, y){
                ...
                core.attributed.get("onFixation").each(function(i){
					...
					var elem = $(this)
					//lkastler: hack for embedding text2.0 into a firefox extension
					elem = XPCNativeWrapper.unwrap(elem.context);
					
					// If an element with onGazeOut is under gaze, ignore it.
                    if (allUnderCurrentGaze.indexOf(elem) < 0)
                        return;					
            ...
            onPerusalHandler: function(e){
                ...
                core.attributed.get("onPerusal").each(function(i){
                    ...
                    if (match) {
						...
						//lkastler: hack for embedding text2.0 into a firefox extension
						if(elem instanceof XrayWrapper)
							elem = XPCNativeWrapper.unwrap(this);
